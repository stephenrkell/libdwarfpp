 ...
 *
 * Copyright (c) 2013--17, Stephen Kell. For licensing information, see the
...
#undef opcode_from_byte
	...
	namespace core
	{
		using dwarf::util::read_8byte_le;
		using dwarf::util::read_4byte_le;
		using dwarf::util::read_2byte_le;
		using dwarf::util::read_8byte_be;
		using dwarf::util::read_4byte_be;
		using dwarf::util::read_2byte_be;
		using dwarf::util::read_addr;
